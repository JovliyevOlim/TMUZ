...
const Users = () => {
  ...
  const { employees, isAction } = useSelector((state: any) => state.Employees);
  ...
  return (
    <>
      ...
      <div className={'flex justify-end my-3'}>
        {checkPermission(userPermissions, ['ADD_EMPLOYEE']) && (
          <button
                  ...
                  <tr key={key}>
                    <td>
                      <img
                        ...
                        src={
                          item.attachmentId
                            ? `${baseUrl}/attachment/download/${item.attachmentId}`
                            : userSix
                        }
