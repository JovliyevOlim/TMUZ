                ...
                <div className={'basis-1/2 '}>
                  ...
                  >
                    <div>
                      ...
                      <div className={'my-2'}>
                        <label htmlFor="levelCrossingId" className="block text-md font-medium leading-6 text-gray-900">
                          Kesishmani tanlang
                        </label>
                        <div className="mt-2">
                          <div className="relative inline-block w-full">
                      ...
                      ring-zinc-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        ...
                        {validation.touched.levelCrossingId && validation.errors.levelCrossingId ? (
                          <h6 className="block text-md font-medium leading-6 text-red-900">
                            {validation.errors.levelCrossingId}
                          </h6>
                        ) : null}
                      </div>
                      {
