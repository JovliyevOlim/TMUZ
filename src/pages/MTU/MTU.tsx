...
import { AddMTU } from './AddMTU.tsx';
import { deleteMtu, getAllMtu } from '../../slices/mtu/thunk.ts';
...
const MTU = () => {
  ...
  const { mtu, isAction } = useSelector((state: any) => state.Mtu);
  ...
  const deleteFunction = () => {
    dispatch(deleteMtu(editData?.id));
  ...
  return (
    <>
      ...
      <AddMTU modalOpen={modal} setModalOpen={setModal} item={editData} setItem={setEditData} />
