...
export const AddPeregonDevice = ({ modalOpen, setModalOpen, item, setItem }: any) => {
  ...
  const validation: any = useFormik({
    ...
    validationSchema: Yup.object({
      name: Yup.string().required('Qurilma turi nomini kiriting!')
    }),
    onSubmit: (values) => {
      if (item) {
            ...
            >
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <div className="divide-y divide-blue-200">
                  <h5 className={'text-title-md font-semibold text-black dark:text-white '}>Qurilma turi yaratish</h5>
                </div>
                <div className={'my-2'}>
