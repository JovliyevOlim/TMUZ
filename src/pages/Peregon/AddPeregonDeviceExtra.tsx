...
export const AddPeregonDeviceExtra = ({ modalOpen, setModalOpen, item, setItem }: any) => {
  ...
  const [peregonId, setPeregonId] = useState<any>(null);
  ...
  useEffect(() => {
    if (deviceItem) {
      setInitialValues({
        ...
        peregonId: deviceItem?.peregonId,
  ...
  const validation: any = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      peregonId: Yup.string().required('Peregonni tanlang!'),
                  ...
                  >
                    <div>
                          ...
                          <div className="relative inline-block w-full">
                            <select
                              ...
                              onChange={(e: any) => {
                                ...
                                if (e.target.value) {
                                  dispatch(getPeregonByPlotId(e.target.value));
                                }
                              }}
                      ...
                      </div>
                      {
                        plotId &&
                        <div className={'my-2'}>
                          <label htmlFor="peregonId" className="block text-md font-medium leading-6 text-gray-900">
                            Peregon
                          </label>
                          <div className="mt-2">
                            <div className="relative inline-block w-full">
                              <select
                                ...
                                onBlur={validation.handleBlur}
                                value={validation.values.peregonId || ''}
                                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1
                      ring-zinc-400 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                <option value="" className="text-body dark:text-bodydark">
                                  Tanlang
