...
import { deleteStation, getAllStation } from '../../slices/station/thunk.ts';
  ...
  return (
    <>
      ...
      <div className={'flex justify-end my-3'}>
        {
          checkPermission(userPermissions, ['ADD_STATION']) &&
          <button
                ...
                <tr key={key}>
                  ...
                  <td>
                    <div className="flex items-center justify-center p-2.5  gap-2 xl:p-5">
                      {
                        checkPermission(userPermissions, ['EDIT_STATION']) &&
                      ...
                      {
                        checkPermission(userPermissions, ['DELETE_STATION']) &&
      ...
      <DeleteModal modalOpen={modalDelete} setModalOpen={setModalDelete} text={'Stansiya'} setItem={setEditData}
