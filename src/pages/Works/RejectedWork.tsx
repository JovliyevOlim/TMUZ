...
import { confirmJob, pauseJob } from '../../slices/work/thunk.ts';
import {
  Dialog,
  DialogBackdrop,
  DialogPanel
...
export const RejectedWork = ({ modalOpen, setModalOpen, item, setItem }: any) => {
  ...
  const validation: any = useFormik({
    ...
    validationSchema: Yup.object({
      description: Yup.string().required('Sababni yozing !')
    }),
    onSubmit: (values) => {
      dispatch(confirmJob(values));
    }
  });
