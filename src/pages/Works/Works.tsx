...
const Works = () => {
  ...
  const { userId, userPermissions, employeeEnterPriceId } = useSelector(
  ...
  const getAllWorkExampleCheck = checkPermission(userPermissions, [
    'JOB_EXAMPLE',
  ]);
  ...
  return (
    <>
          ...
          <div className="mt-2">
            <div className="relative inline-block w-full">
              ...
              >
                ...
                <option value="year" className="text-body dark:text-bodydark">
                  Rejaviy yillik ishlar
                </option>
              </select>
            </div>
          </div>
            ...
            <table className="min-w-171.5 sm:min-w-full table-fixed">
              <thead>
                <tr className="text-start text-sm font-medium uppercase xsm:text-base">
                  ...
                  <th className="p-2.5 text-start">Tasdiqlagan xodim</th>
      ...
      <PauseWork
        modalOpen={pausedJob}
        setModalOpen={setPausedJob}
        item={editData}
        setItem={setEditData}
      />
      <RejectedWork
        modalOpen={rejectedJob}
        setModalOpen={setRejectedJob}
        item={editData}
        setItem={setEditData}
      />
    </>
