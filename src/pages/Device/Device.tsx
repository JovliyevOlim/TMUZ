          ...
          <div className="overflow-x-auto">
            <table className="min-w-115 sm:min-w-full table-fixed">
              ...
              {categoryTrue?.map((item: any, key: number) => (
                <tr key={key}>
                  <td>
                    <p onClick={() => checkPermission(userPermissions, ['GET_DEVICE']) && onClickEditStation(item)}
                  ...
                  <td>
                    <div className="flex items-center justify-center p-2.5  gap-2 xl:p-5">
                      {
                        checkPermission(userPermissions, ['EDIT_CATEGORY']) &&
                      ...
                      {
                        checkPermission(userPermissions, ['DELETE_CATEGORY']) &&
