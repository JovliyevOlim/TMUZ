...
import { deleteLevelCrossing, getAllLevelCrossing } from '../../slices/levelCrossing/thunk.ts';
...
const LevelCrossing = () => {
  ...
  const deleteFunction = () => {
    dispatch(deleteLevelCrossing(editData?.id));
  ...
  return (
    <>
      ...
      <div className={'flex justify-end my-3'}>
        {
          checkPermission(userPermissions, ['ADD_LEVEL_CROSSING']) &&
          <button
                ...
                <tr key={key}>
                  ...
                  <td>
                    <div className="flex items-center justify-center p-2.5  gap-2 xl:p-5">
                      {
                        checkPermission(userPermissions, ['EDIT_LEVEL_CROSSING,']) &&
                      ...
                      {
                        checkPermission(userPermissions, ['DELETE_LEVEL_CROSSING']) &&
