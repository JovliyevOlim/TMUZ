    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/" className={'flex items-center justify-between'}>
          ...
          <h6 className="ml-4 text-sm font-semibold text-bodydark2">
            Texnologik Jarayonlarning elektron nazorati (TJEN)
          </h6>
        </NavLink>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {/*</li>*/}
              {
                checkPermission(userPermissions, ['GET_EMPLOYEE',
                  'ADD_EMPLOYEE',
                  'DELETE_EMPLOYEE',
                  'EDIT_EMPLOYEE',
                  'GET_USER',
              ...
              {
                checkPermission(userPermissions, ['GET_ENTERPRISE',
                  'ADD_ENTERPRISE',
                  'DELETE_ENTERPRISE',
                  'EDIT_ENTERPRISE'
                ]) && <li>
              ...
              {
                checkPermission(userPermissions, ['GET_PLOT',
                  'ADD_PLOT',
                  'DELETE_PLOT',
                  'EDIT_PLOT'
                ]) &&
              ...
              {
                checkPermission(userPermissions, ['GET_STATION',
                  'ADD_STATION',
                  'DELETE_STATION',
                  'EDIT_STATION'
                ]) &&
                <li>
                  <NavLink
                    to="/stations"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('stations') && 'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
                      className="fill-current"
              ...
              }
              {
                checkPermission(userPermissions, [
                  ...
                  <NavLink
                    to="/levelCrossing"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('levelCrossing') &&
                      'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
              ...
              }
              {
                checkPermission(userPermissions, [
                  ...
                  <NavLink
                    to="/peregonDevice"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname.includes('peregonDevice') &&
                      'bg-graydark dark:bg-meta-4'
                    }`}
                  >
                    <svg
